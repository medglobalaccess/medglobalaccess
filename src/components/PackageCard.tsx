...
const PackageCard = ({ title, description, features, highlighted }: PackageCardProps) => {
  return (
    <Card className={`relative h-full flex flex-col hover:-translate-y-2 transition-all duration-500 ${highlighted ? "border-primary/50 shadow-2xl scale-105 bg-gradient-to-br from-primary/5 to-accent/5" : "border-border/50 hover:shadow-xl"}`}>
      {highlighted && (
